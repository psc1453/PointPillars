...
class PillarEncoder(nn.Module):
    ...
    def forward(self, pillars, coors_batch, npoints_per_pillar):
        ...
        #       [Batch_Size x Num_Points x 4] # Point Values (x, y, z, r)
        #       [Batch_Size x Num_Points x 3] # Offset to Point Average in Pillar (offset_x, offset_y, offset_z)
        #       [Batch_Size x Num_Points x 1] # Offset to Pillar x Center (offset_x_p)
        #       [Batch_Size x Num_Points x 1] # Offset to Pillar y Center (offset_y_p)
        #   =>  [Batch_Size x Num_Points x 9]
